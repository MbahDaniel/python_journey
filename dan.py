...
cursor.execute("""INSERT INTO phone(id,firstname,surname,phonenumber)
 VALUES("0","Simon","Howels","01223349752")""")
db.commit()

cursor.execute("""INSERT INTO phone(id,firstname,surname,phonenumber)
  VALUES("1","Karen","phillips","01954295773")""")
db.commit()

cursor.execute("""INSERT INTO phone(id,firstname,surname,phonenumber)
  VALUES("2","Darren","smith","01583749012")""")
db.commit
cursor.execute("""INSERT INTO phone(id,firstname,surname,phonenumber)
  VALUES("3","Anne","jones","01323567322")""")
db.commit
cursor.execute("""INSERT INTO phone(id,firstname,surname,phonenumber)
  VALUES("4","Mark","smith","01223855534")""")
db.commit()
